---
name: Cellular Automata Neighbourhoods
slug: cellular-automata-neighbourhoods
desc: Explore how neighbourhoods are calculated in one-dimensional and two-dimensional cellular automata, including the von Neumann and Moore neighbourhoods.
thmb: /content/cellular-automata-neighbourhoods/thumbnail.png
date: 2022-01-05
...
{% include figure.md figure=1 title="Cell Neighbourhood Examples" %}
...
{% include figure.md figure=2 title="Cell Neighbourhood in One Dimension" %}
...
{% include figure.md figure=3 title="Cell Neighbourhood in One Dimension With Range 2" %}
...
{% include figure.md figure=4 title="von Neumann Cell Neighbourhood" %}
...
{% include figure.md figure=5 title="Colour Coded Manhattan Distance" %}
...
{% include figure.md figure=6 title="Moore Cell Neighbourhood" %}
...
{% include figure.md figure=7 title="Colour Coded Manhattan Distance" %}
